...
<div class="container-fluid">
        ...
        <div class="col-md-12 ">
            <div class="card card-success border border-2 border-dark bg-light">
                ...
                <div class="card-body ">
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="dam_id" name="dam_id" class="form-control dam_select" data-placeholder="Search dam here.." required>
                                </select>
                            </div>
                        </div>
                    </div>
                    <!-- form start -->
                    <form method="post" id="fish_form" action="{{ url('dam_detail/create_dam_fish') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="dam_id" id="form1_dam_id" value="">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="row my-4">
                                    <div class="col-md-12 ">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center" onclick="get_fishes('{{$fish->dam_detail_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                                                    <td onclick="global_delete('<?= $fish->dam_detail_id ?>','dam_detail');"><i class="fa-solid fa-trash"></i></td>
                                                                </tr>
                                                                @php
                                                                $count++;
                                                                @endphp
                    ...
                    <form method="post" id="license_form" action="{{ url('dam_detail/create_dam_license') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="dam_id" id="form2_dam_id" value="">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" onclick="get_licenses('{{$license->dam_license_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                        <td onclick="global_delete('<?= $license->dam_license_id ?>','dam_licenses');"><i class="fa-solid fa-trash"></i></td>
                                    </tr>
                                    @php
                                    $count++;
                                    @endphp
                    ...
                    <form method="post" id="lease_form" action="{{ url('dam_detail/create_dam_lease') }}" enctype="multipart/form-data">
                        @csrf

                        <input type="hidden" name="dam_id" id="form3_dam_id" value="">

                        <div class="row mt-5">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="fw-bold">Dam Total Lease Value </label>
                                    <input type="text" name="lease_value" placeholder="Dam Total Lease Value " class="form-control" autocomplete="off" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$lease->amount}}</td>
                                        <td class="text-center" onclick="get_Leases('{{$lease->dam_leases_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                        <td onclick="global_delete('<?= $license->dam_leases_id ?>','dam_leases');"><i class="fa-solid fa-trash"></i></td>
                                    </tr>
                                    @php
                                    $count++;
                                    @endphp
    ...
    <script>
        // Update hidden input value when dam selection changes

        $('#dam_id').change(function() {
            var selectedDamId = $(this).val();
            $('#form1_dam_id').val(selectedDamId);
            $('#form2_dam_id').val(selectedDamId);
            $('#form3_dam_id').val(selectedDamId);
        });

        $('#fish_form, #license_form, #lease_form').submit(function(e) {
            var selectedDamId = $('#dam_id').val();

            // Check if a dam has been selected
            if (!selectedDamId) {
                alert('Please select a Dam before submitting the form.');
                e.preventDefault();
            }
        });
    </script>
