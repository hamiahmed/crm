...
<div class="container-fluid">
        ...
        <div class="col-md-12 ">
            <div class="card card-success border border-2 border-dark bg-light">
                ...
                <div class="card-body ">
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="river_id" name="river_id" class="form-control river_select" data-placeholder="Search river here.." required>
                                </select>
                            </div>
                        </div>
                    </div>
                    <!-- form start -->
                    <form method="post" id="fish_form" action="{{ url('river_detail/create_river_fish') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="river_id" id="form1_river_id" value="">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="row my-4">
                                    <div class="col-md-12 ">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center" onclick="get_fishes('{{$fish->river_fish_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                                                    <td onclick="global_delete('<?= $fish->river_fish_id ?>','river_fish');"><i class="fa-solid fa-trash"></i></td>
                                                                </tr>
                                                                @php
                                                                $count++;
                                                                @endphp
                    ...
                    <form method="post" id="license_form" action="{{ url('river_detail/create_river_license') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="river_id" id="form2_river_id" value="">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" onclick="get_licenses('{{$license->river_license_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                        <td onclick="global_delete('<?= $license->river_license_id ?>','river_licenses');"><i class="fa-solid fa-trash"></i></td>
                                    </tr>
                                    @php
                                    $count++;
                                    @endphp
                    ...
                    <form method="post" id="lease_form" action="{{ url('river_detail/create_river_lease') }}" enctype="multipart/form-data">
                        @csrf

                        <input type="hidden" name="river_id" id="form3_river_id" value="">

                        <div class="row mt-5">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="fw-bold">River Total Lease Value </label>
                                    <input type="text" name="lease_value" placeholder="River Total Lease Value " class="form-control" autocomplete="off" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$lease->amount}}</td>
                                        <td class="text-center" onclick="get_Leases('{{$lease->river_leases_id}}')"><i class="fa-solid fa-pen-to-square"></i></td>
                                        <td onclick="global_delete('<?= $license->river_leases_id ?>','river_leases');"><i class="fa-solid fa-trash"></i></td>
                                    </tr>
                                    @php
                                    $count++;
                                    @endphp
    ...
    <script>
        ...
        $('#river_id').change(function() {
            var selectedRiverId = $(this).val();
            $('#form1_river_id').val(selectedRiverId);
            $('#form2_river_id').val(selectedRiverId);
            $('#form3_river_id').val(selectedRiverId);
        });

        $('#fish_form, #license_form, #lease_form').submit(function(e) {
            var selectedRiverId = $('#river_id').val();

            if (!selectedRiverId) {
                alert('Please select a River before submitting the form.');
                e.preventDefault();
            }
        });
    </script>
