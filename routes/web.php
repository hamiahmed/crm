...
Route::middleware([user_authentication::class])->group(function () {
    Route::middleware([rolecheck::class])->group(function () {
        ...
        Route::group(['prefix' => 'dam_detail'], function () {
            Route::get('/', [Water_bodies::class, 'dam_details']);
            Route::post('/create_dam_fish', [Water_bodies::class, 'add_dam_fish_details']);
            Route::post('/create_dam_license', [Water_bodies::class, 'add_dam_license_details']);
            Route::post('/create_dam_lease', [Water_bodies::class, 'add_dam_lease_details']);
        });
        Route::group(['prefix' => 'river_detail'], function () {
            Route::get('/', [Water_bodies::class, 'river_details']);
            Route::post('/create_river_fish', [Water_bodies::class, 'add_river_fish_details']);
            Route::post('/create_river_license', [Water_bodies::class, 'add_river_license_details']);
            Route::post('/create_river_lease', [Water_bodies::class, 'add_river_lease_details']);
        });

        Route::group(['prefix' => 'stream_detail'], function () {
            Route::get('/', [Water_bodies::class, 'stream_details']);
            Route::post('/create_stream_fish',[Water_bodies::class, 'add_stream_fish_details']);
            Route::post('/create_stream_license',[Water_bodies::class, 'add_stream_license_details']);
            Route::post('/create_stream_lease',[Water_bodies::class, 'add_stream_lease_details']);
        });
        ...
        Route::group(['prefix' => 'graphic_report'], function () {
            Route::get('/', [Reports::class, 'graphic_report']);
