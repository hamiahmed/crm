                                        ...
                                        <div class="card card-success border border-2 border-dark bg-light">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row mt-5">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="fw-bold">Streams Total Lease Value </label>
                                                            <input type="text" name="" placeholder="Streams Total Lease Value " class="form-control" autocomplete="off" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <div class="col-md-12 my-5">
                                                    <table class="table">
                                                        <thead class="text-white" style="background-color: #14B8CF;">
                                                            <tr>
                                                                <th scope="col">#</th>
                                                                <th scope="col">Streams Total Lease Value </th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-9 mx-3  " style="text-align: right; margin-bottom: 2%; ">
                                                    <div class="form-group ">
                                                        <button type="submit " style="background-color: #14B8CF; " class="btn text-white shadow float-right ">Submit</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mx-3 " style="text-align: right; ">
                                                    <div class="form-group ">
                                                        <a style="background-color: #14c8A0; " href="KPWaterBodies1.html" class="btn text-white shadow float-right ">Previous</a>
                                                    </div>
                                                </div>
                                            </div>
