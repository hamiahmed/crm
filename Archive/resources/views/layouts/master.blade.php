...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div id="mySidenav" class="sidenav" style="background-color: #14B8CF;">
        ...
        <div class="dropdown-container" id="water-bodies-dd">
            ...
            <a href="{{ url('dams') }}" class="<?php if (isset($_SESSION['page']) && $_SESSION['page'] == 'dams') echo 'dropdown_active'; ?>">Dams Details</a>
            <a href="{{ url('rivers') }}" class="<?php if (isset($_SESSION['page']) && $_SESSION['page'] == 'rivers') echo 'dropdown_active'; ?>">Rivers Details</a>
            <a href="{{ url('streams') }}" class="<?php if (isset($_SESSION['page']) && $_SESSION['page'] == 'streams') echo 'dropdown_active'; ?>">Streams Details</a>
